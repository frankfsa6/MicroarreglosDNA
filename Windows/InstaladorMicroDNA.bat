...
chcp 65001
mode 80,20
echo MsgBox "Bienvenido a MicroarreglosDNA. Enseguida, se va a dirigir a la 'Guia de instalacion'. Siga la parte dedicada a Windows para instalar correctamente el programa. Este archivo ejecutable lo redirige a los enlaces descritos en el documento.", 64, "Instalador Microarreglos DNA">%temp%\InstaDNA.vbs
